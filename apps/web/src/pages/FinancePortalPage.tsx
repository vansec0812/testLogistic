    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <p className="text-[11px] text-slate-500 mt-1">Tiền đã vào tài khoản ECont thành công</p>
        </div>
        ...
        <div className="p-5 rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <p className="text-[11px] text-slate-500 mt-1">Chờ A/B chuyển khoản theo lệnh</p>
        </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold ${
                activeTab === 'orders' ? 'bg-white text-slate-900 shadow-sm border border-slate-200' : 'text-slate-600'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold ${
                activeTab === 'suspense' ? 'bg-white text-slate-900 shadow-sm border border-slate-200' : 'text-slate-600'
              }`}
            >
                ...
                {filteredOrders.length === 0 ? (
                  ...
                  filteredOrders.map(({ txnId, party, order }) => (
                    <tr key={order.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="p-4 font-semibold text-slate-800">{order.companyName}</td>
                      <td className="p-4">
