...
export const DEMO_DATASET_VERSION = "2026-09-24-v2-utf8-clean";
...
export const INITIAL_ASSETS: ContainerAsset[] = [
  {
    ...
    conditionNotes:
      "Sàn gỗ sạch, không thủng nóc, cửa đóng khít, đủ chốt seal. Đạt chuẩn xuất khẩu thực phẩm.",
  ...
  },
  {
    ...
    reviewedCondition: "GOOD",
    conditionNotes:
      "Cont chuẩn thực phẩm, sạch sẽ, không mùi hôi. Gioăng cửa mới thay tháng 8/2026.",
  ...
  },
  {
    ...
    reviewedCondition: "GOOD",
    conditionNotes:
      "Vỏ sạch, khô, cửa vận hành tốt; có dấu xước sử dụng thông thường nhưng không ảnh hưởng khả năng kín nước.",
  ...
  },
  {
    ...
    declaredCondition: "GOOD",
    conditionNotes:
      "Đang tại kho khách hàng, lịch trả rỗng thay đổi nên Offer đã được rút khỏi sàn.",
    currentDepotReturnId: "DEPOT-PL01",
    currentDepotName: "ICD Phước Long 3",
  ...
  },
  {
    ...
    declaredCondition: "GOOD",
    conditionNotes:
      "Vỏ 40HC sạch, sẵn sàng giao tại ICD Phước Long 3; hồ sơ hình ảnh và eDO đã được xác minh.",
    currentDepotReturnId: "DEPOT-PL01",
    currentDepotName: "ICD Phước Long 3",
  ...
  },
  {
    ...
    reviewedCondition: "GOOD",
    conditionNotes:
      "Đã bàn giao thành công cho Toàn Cầu Export Corp. Biên bản giao nhận và ảnh kiểm tra đạt chuẩn.",
    currentDepotReturnId: "DEPOT-TC01",
    currentDepotName: "Depot Tân Cảng Cát Lái",
...
export const INITIAL_OFFERS: Offer[] = [
  {
    ...
    version: 4,
    reviewerNotes:
      "Hồ sơ và 6 ảnh đạt chuẩn. Offer đã ghép với Booking MSK-VN-984210, đang chờ hãng tàu duyệt RU.",
    ...
    conditionNotes:
      "Sàn gỗ sạch, cửa kín, đầy đủ chốt seal; đủ điều kiện giao nhận.",
    createdAt: dAgo(5),
    updatedAt: hAgo(1),
  },
  {
    ...
    version: 2,
    reviewerNotes:
      "Đã thẩm định hình ảnh 6 góc và eDO; đủ điều kiện ghép Booking CMA 40HC.",
    reviewedBy: "ops.lead@econt.vn",
    reviewedAt: hAgo(5),
    ...
    conditionNotes:
      "Cont sạch, khô, không mùi; gioăng cửa tốt và sẵn sàng bàn giao.",
    createdAt: hAgo(5),
    updatedAt: hAgo(2),
  },
  {
  ...
  },
  {
    ...
    conditionNotes:
      "Vỏ 20GP sạch và khô; ảnh kiểm tra xác nhận không có hư hỏng ảnh hưởng khai thác.",
    createdAt: hAgo(4),
    updatedAt: hAgo(1),
  },
  {
  ...
  },
  {
    ...
    conditionNotes:
      "Đã giao nhận thành công, vỏ hiện thuộc quyền quản lý của bên cần vỏ.",
    createdAt: dAgo(28),
    updatedAt: dAgo(2),
  },
];
