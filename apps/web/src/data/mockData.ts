...
export const INITIAL_REQUESTS: ContainerRequest[] = [
  ...
  },
  {
    ...
    bookingAiCheck: {
      ...
      hasAnomaly: false,
      score: 96,
      summary: 'File Booking mẫu hợp lệ, thông tin hãng tàu và số Booking có thể đối chiếu.',
      details: ['Hãng tàu: CMA CGM', 'Số Booking: CMA-VN-771290', 'Loại container: 40HC'],
...
export const INITIAL_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    recipientCompanyId: 'COMP-A01',
    type: 'TRANSACTION_UPDATE',
    title: 'Offer OFR-2026-001 đã được Ops phê duyệt',
    body: 'Nguồn vỏ cont MSKU8421093 tại ICD Transimex đã được duyệt AVAILABLE và xuất hiện trên sàn.',
  ...
  },
  {
    ...
    recipientCompanyId: 'COMP-B01',
    type: 'TRANSACTION_UPDATE',
    title: '⚡ Radar: Tìm thấy 2 nguồn vỏ phù hợp với REQ-2026-001',
    body: 'Phát hiện cont 40HC Maersk tại ICD Transimex khớp 94% với tuyến xuất khẩu của bạn.',
    relatedEntityId: 'REQ-2026-001',
  ...
  },
  {
    ...
    type: 'OPS_ALERT',
    title: '🔔 Cần thẩm định: 1 Offer mới và 1 Doanh nghiệp chờ KYC',
    body: 'Đơn vị Hưng Thịnh gửi duyệt nguồn cont mới. Cần kiểm tra hồ sơ eDO và 6 góc ảnh IICL.',
    relatedEntityId: 'OFR-2026-003',
    relatedEntityType: 'Offer',
    isRead: false,
    createdAt: hAgo(0.8),
  },
