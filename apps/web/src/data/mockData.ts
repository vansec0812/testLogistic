...
export const DEMO_DATASET_VERSION = '2026-09-19-full-flow-r2';
...
export const INITIAL_REQUESTS: ContainerRequest[] = [
  {
    ...
    bookingAiCheck: {
      status: 'VALID', isValid: true, hasAnomaly: false, score: 98,
      summary: 'Booking hợp lệ, đã được dùng trong giao dịch chờ duyệt RU.',
      details: ['Hãng tàu: Maersk', 'Loại container: 40HC'], requiresOpsReview: false,
    },
    createdAt: hAgo(9),
    updatedAt: hAgo(1),
  },
  {
    ...
    bookingFileMimeType: 'application/pdf',
    bookingAiCheck: {
      status: 'VALID', isValid: true, hasAnomaly: false, score: 96,
      summary: 'File Booking hợp lệ, thông tin hãng tàu và số Booking đã đối chiếu.',
      details: ['Hãng tàu: CMA CGM', 'Số Booking: CMA-VN-771290', 'Loại container: 40HC'], requiresOpsReview: false,
    },
    createdAt: hAgo(6),
    updatedAt: hAgo(2),
  },
  {
    ...
    bookingFileMimeType: 'application/pdf',
    bookingAiCheck: {
      status: 'VALID', isValid: true, hasAnomaly: false, score: 95,
      summary: 'Booking ONE 20GP hợp lệ, sẵn sàng nhận đề xuất auto-match.',
      details: ['Hãng tàu: ONE', 'Số Booking: ONE-VN-100234', 'Loại container: 20GP'], requiresOpsReview: false,
    },
    createdAt: hAgo(5),
    updatedAt: hAgo(1),
  },
  {
    ...
    status: 'UNDER_REVIEW',
    version: 1,
    reviewerNotes: 'Đang chờ Ops kiểm tra file Booking trước khi bật auto-match.',
    ...
    bookingFileMimeType: 'application/pdf',
    bookingAiCheck: {
      status: 'MANUAL_REVIEW', isValid: false, hasAnomaly: false, score: 72,
      summary: 'AI đã đọc file nhưng cần Ops đối chiếu thêm thời hạn Booking.',
      details: ['Cần kiểm tra thời hạn Booking trên cổng hãng tàu'], requiresOpsReview: true,
    },
    createdAt: hAgo(2),
    updatedAt: hAgo(1),
  },
  {
    ...
    bookingFileMimeType: 'application/pdf',
    bookingAiCheck: {
      status: 'VALID', isValid: true, hasAnomaly: false, score: 97,
      summary: 'Booking hoàn tất, chứng từ đã được lưu.',
      details: ['Hãng tàu: Maersk', 'Loại container: 20GP'], requiresOpsReview: false,
    },
    createdAt: dAgo(16),
    updatedAt: dAgo(2),
  },
